...
import com.application.service.AppointmentEmailService;
...
public class UserController 
{
	...
	public ResponseEntity<Appointments> addNewAppointment(@RequestBody Appointments appointment) throws Exception
	{
		...
		try
		{
			appointmentEmailService.sendAppointmentBookedEmail(appointments);
		}
		catch(Exception ex)
		{
			System.out.println("Appointment confirmation email was not sent: " + ex.getMessage());
		}
