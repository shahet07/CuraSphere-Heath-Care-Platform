...
import { AppointmentsuccessComponent } from './components/appointmentsuccess/appointmentsuccess.component';
...
import { CareoperationsComponent } from './components/careoperations/careoperations.component';
...
import { FuturecarehubComponent } from './components/futurecarehub/futurecarehub.component';
...
const routes: Routes = [
  ...
  {path:'aiassistant',component:AiassistantComponent,canActivate:[RouterGuard]},
  {path:'careoperations',component:CareoperationsComponent,canActivate:[RouterGuard]},
  {path:'futurecarehub',component:FuturecarehubComponent,canActivate:[RouterGuard]},
  {path:'bookappointment',component:BookappointmentComponent,canActivate:[UserGuard]},
  {path:'appointmentsuccess',component:AppointmentsuccessComponent,canActivate:[UserGuard]},
